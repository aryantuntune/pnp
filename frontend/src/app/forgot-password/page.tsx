        ...
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10">
          {sent ? (
            ...
            <>
              ...
              <div className="flex items-start gap-2.5 text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-xl p-4 mb-2">
                ...
                <span>
                  No email on your account? Please contact your manager or admin to add one to your account so you can use password reset.
                </span>
              </div>
