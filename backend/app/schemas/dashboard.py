...
class BranchStat(BaseModel):
    ...
    cancelled_count: int = Field(0, description="Number of cancelled tickets for this branch today")
...
class TodaySummaryResponse(BaseModel):
    ...
    total_cancelled: int = Field(0, description="Total cancelled ticket count for today")
